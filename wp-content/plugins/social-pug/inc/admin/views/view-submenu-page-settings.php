	...
	<form method="post" action="options.php">
		...
		<div id="dpsp-tab-general-settings" class="dpsp-tab <?php echo ( $active_tab == 'general-settings' ? 'dpsp-tab-active' : '' ); ?>">
			...
			<div class="dpsp-section">
				...
				<?php dpsp_settings_field( 'checkbox', 'dpsp_settings[twitter_share_counts]', ( isset($dpsp_settings['twitter_share_counts']) ? $dpsp_settings['twitter_share_counts'] : '' ), __( 'Enable Twitter Tweet Counts', 'social-pug' ), array('yes'), sprintf( __( 'We have partenered with %1$sNew Share Counts%3$s to bring back Twitter Share Counts. You will need to register your website on %1$stheir website%3$s in order for Social Pug to be able to return the share counts. For a step by step tutorial read %2$sthis article%3$s.', 'social-pug' ), '<a href="http://newsharecounts.com/" target="_blank">', '<a href="http://docs.devpups.com/social-pug/how-to-activate-twitter-tweet-counts/" target="_blank">', '</a>' ) ); ?>
