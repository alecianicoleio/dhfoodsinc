...
"");b.options.defaultValue[c]=a(this).val()});b.options.editor=a("#"+b.id+"_editor").is(":checked")}).on("ptb_metabox_create_radio_button",function(b){function c(b){b.preventDefault();b.data.option.hide("blind",500,function(){a(this).remove()})}function e(b){b=a(b.data.option.selector).find('input[name^="'+b.data.id+'_options_"]').map(function(){return a(this).data("id")});b=b.filter(function(a){return 0<a});(b=0===b.length?0:Math.max.apply(null,b))||(b=0);return++b}function d(b){a(b.data.label.selector).remove();
...
d).data("id",d)});l.find("."+b.id+"_remove").click({option:l},c);var q=l.find('input[name="'+b.id+'_default_selected"]'),l=l.find("."+b.id+"_default_selected_label");e.selected||l.remove();q.attr("checked",e.selected).click({label:l,selector:q.selector},d)});h.sortable({placeholder:"ui-state-highlight"});b.container.find("#"+b.id+"_add_new").click({id:b.id,option:f,wrapper:h},function(a){a.preventDefault();var b=a.data.option.clone(),h=b.find('input[name="'+a.data.id+'_default_selected"]'),g=b.find("."+
a.data.id+"_default_selected_label");h.click({label:g,selector:h.selector},d);var f=e(a);b.find('input[name^="'+a.data.id+'_options_"]').val("").attr("id",a.data.id+"_"+f).data("id",f);h.attr("checked",!1);g.remove();b.find("."+a.data.id+"_remove").click({option:b},c);b.appendTo(a.data.wrapper).hide().show("blind",500);a.data.wrapper.sortable("refresh")})}).on("ptb_add_metabox_radio_button",function(a){return{options:[{name:"Option 1",id:1,selected:!0},{name:"Option 2",id:2,selected:!1}]}}).on("ptb_metabox_save_radio_button",
function(b){b.options.options={};a("#"+b.id+"_options_wrapper").children("li").each(function(c){var e=a(this).find("input[name^="+b.id+"_options_]"),d=a(this).find("input[name^="+b.id+"_default_selected]").is(":checked");b.options.options[c]={};e.each(function(){var e=a(this).attr("name").replace(b.id+"_options_",""),e=e.replace("[]","");b.options.options[c][e]=a(this).val();b.options.options[c].selected=d;b.options.options[c].id=a(this).attr("id")})})}).on("ptb_metabox_create_checkbox",function(b){function c(b){b=
...
"_options_",""),c=c.replace("[]",""),c=g[c]?g[c]:g.name,d=a.isNumeric(g.id)?g.id:g.id.replace(b.id+"_","");a(this).val(c).attr("id",b.id+"_"+d).data("id",d)});h.find("."+b.id+"_remove").click({option:h},e);h.find('input[name="'+b.id+'_default_checked"]').attr("checked",g.checked)});f.sortable({placeholder:"ui-state-highlight"});b.container.find("#"+b.id+"_add_new").click({id:b.id,option:d,wrapper:f},function(a){a.preventDefault();var b=a.data.option.clone(),d=c(a);b.find('input[name^="'+a.data.id+
'_options_"]').val("").attr("id",a.data.id+"_"+d).data("id",d);b.find('input[name="'+a.data.id+'_default_checked"]').attr("checked",!1);b.find("."+a.data.id+"_remove").click({option:b},e);b.appendTo(a.data.wrapper).hide().show("blind",500);a.data.wrapper.sortable("refresh")})}).on("ptb_add_metabox_checkbox",function(a){return{options:[{name:"Option 1",id:1,checked:!1},{name:"Option 2",id:2,checked:!1}]}}).on("ptb_metabox_save_checkbox",function(b){b.options.options={};a("#"+b.id+"_options_wrapper").children("li").each(function(c){var e=
a(this).find("input[name^="+b.id+"_options_]"),d=a(this).find("input[name^="+b.id+"_default_checked]").is(":checked");b.options.options[c]={};e.each(function(){var e=a(this).attr("name").replace(b.id+"_options_",""),e=e.replace("[]","");b.options.options[c][e]=a(this).val();b.options.options[c].checked=d;b.options.options[c].id=a(this).attr("id")})})}).on("ptb_metabox_create_select",function(b){function c(b){b=a(b.data.option.selector).find('input[name^="'+b.data.id+'_options_"]').map(function(){return a(this).data("id")});
b=Math.max.apply(null,b);return++b}function e(b){b.preventDefault();b.data.option.hide("blind",500,function(){a(this).remove()})}b.container.find('input[name="'+b.id+'_multiple_selects"]').filter('[value="'+(b.options.multipleSelects?"Yes":"No")+'"]').attr("checked",!0);var d=b.container.find("."+b.id+"_option_wrapper"),f=b.container.find("#"+b.id+"_options_wrapper");d.remove();a.each(b.options.options,function(c,g){var h=d.clone();h.appendTo(f);h.find('input[name^="'+b.id+'_options_"]').each(function(){var c=
...
"_"+d).data("id",d);b.find("."+a.data.id+"_remove").click({option:b},e);b.appendTo(a.data.wrapper).hide().show("blind",500);a.data.wrapper.sortable("refresh")})}).on("ptb_add_metabox_select",function(a){return{multipleSelects:!1,options:[{name:"Option 1",id:1},{name:"Option 2",id:2}]}}).on("ptb_metabox_save_select",function(b){b.options.multipleSelects="Yes"==a('input[name="'+b.id+'_multiple_selects"]:checked').val();b.options.options={};a("#"+b.id+"_options_wrapper").children("li").each(function(c){var e=
a(this).find("input[name^="+b.id+"_options_]");b.options.options[c]={};e.each(function(){var d=a(this).attr("name").replace(b.id+"_options_",""),d=d.replace("[]","");b.options.options[c][d]=a(this).val();b.options.options[c].id=a(this).attr("id")})})}).on("ptb_add_metabox_image",function(a){return{}}).on("ptb_post_cmb_image_body_handle",function(b){a('input[name="'+b.id+'[]"][type="text"]').on("paste keyup keypress change",function(c){var d=a(this);a('input[name="'+b.id+'[]"][type="hidden"]').val("");
setTimeout(function(){a("#image_"+b.id).css("background-image","url("+d.val()+")")},100)});var c;a("#image_"+b.id).on("click",function(e){e.preventDefault();c||(c=wp.media.frames.file_frame=wp.media({title:a(this).data("uploader_title"),button:{text:a(this).data("uploader_button_text")},library:{type:"image"},multiple:!1}),c.on("select",function(){var d=c.state().get("selection").first().toJSON();a('input[name="'+b.id+'[]"][type="hidden"]').val(d.id);a('input[name="'+b.id+'[]"][type="text"]').val(d.url);
a("#image_"+b.id).css("background-image","url("+d.url+")")}));c.open()})}).on("ptb_add_metabox_link_button",function(a){return{}});var n="text textarea radio_button checkbox select image link_button".split(" "),p;for(p in n)a(document).on("ptb_template_item_create_"+n[p],function(a){a.title.html(a.options.name)});a(document).on("ptb_template_item_create_title",function(a){a.title.html("Title")}).on("ptb_template_item_create_content",function(a){a.title.html("Content")});f(function(){var b,c,e,d,f,
h,g,k,l,m=function(){c.click(function(b){b.preventDefault();k=a("a.nav-tab-active").data("target");switch(k){case "cpt":b=d;break;case "ctx":b=f;break;case "ptt":b=h;break;default:b=d}b={mode:l,target:k,list:b.find("input:checked").map(function(){return a(this).val()}).get()};a('input[name="ptb_plugin_options[ptb_ie_export]"]').val(JSON.stringify(b));a("form#ptb_form_export").submit()})},n=function(){e.addClass("disabled");a("input:file").change(function(){a(this).val()?e.removeClass("disabled"):
e.addClass("disabled")});e.click(function(b){b.preventDefault();a("input:file").val()&&a("form#ptb_form_import").submit()})},p=function(){a(".nav-tab-wrapper a").click(function(b){b.preventDefault();a(this).hasClass("nav-tab-active")||(a(this).addClass("nav-tab-active").siblings().removeClass("nav-tab-active"),b=a(this).attr("href"),a(".ptb_tab_content").not(b).css("display","none"),a(b).fadeIn())})},t=function(){g.change(function(a){v()})},v=function(){l=g.filter(":checked").val();var b=a('a[href="#ptb_export_cpt_list"]').siblings();
"linked"===l?b.fadeOut().click():b.fadeIn()};return{init:function(){b=a("form#ptb_form_export");if(0===b.length)var k=!1;else g=a('input[name="ptb_export_mode"]'),v(),c=a("#ptb_export"),e=a("#ptb_import"),d=a("#ptb_export_cpt_list"),f=a("#ptb_export_ctx_list"),h=a("#ptb_export_ptt_list"),k=!0;k&&(t(),p(),m(),n())}}}());a(function(){a(document).ready(function(){a(".ptb_interface select").wrap("<div class='ptb_custom_select'></div>");a(".ptb_number").keyup(function(){/^[1-9][0-9]*[.,]*[0-9]*$/gi.test(a(this).val())||
a(this).val(a(this).val().replace(/[^0-9.,]/,""))});a(document).on("click",".ptb_remove_dialog_form input",function(b){b.preventDefault();b.stopPropagation();b=a(this).closest("form");var c=a(this).data("confirm");if(c&&!confirm(c))return!1;a('input[name="remove"]',b).val(c?"1":"0");var e=a(".ptb_alert",b);a.ajax({type:"POST",url:ajaxurl,dataType:"json",data:b.serialize(),beforeSend:function(){e.removeClass("done error").addClass("busy").show()},complete:function(){e.removeClass("busy")},success:function(a){if(a){var b=
"";if(a.success){b="done";var c=function(){"1"==a.data?window.location.reload():window.location=a.data}}else b="error",c=function(){a.data&&alert(a.data)};e.addClass(b);setTimeout(function(){e.animate({opacity:0},300,c)},800)}}})}).on("click",".ptb_register,.ptb_unregister,.ptb_cpt_copy,.ptb_ctx_copy",function(b){b.preventDefault();b.stopPropagation();a.ajax({type:"POST",url:this,dataType:"json",success:function(a){a&&("1"==a.data?window.location.reload():window.location=a.data)}})})})})})(jQuery);
