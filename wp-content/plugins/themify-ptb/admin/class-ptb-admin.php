...
class PTB_Admin {
    ...
    public function enqueue_scripts() {
        ...
        wp_register_style($this->plugin_name,PTB_Utils::enque_min( $plugin_dir . 'css/ptb-admin.css'), array(), $this->version, 'all');
        if ($screen->id != 'customize') {
            ...
            wp_register_script($this->plugin_name, PTB_Utils::enque_min($plugin_dir . 'js/ptb-admin.js'), array('jquery'), $this->version, false);
            if (in_array($screen->id, $screens)) {
                ...
                if (!wp_style_is('themify-icons')) {
                    wp_enqueue_style('themify-icons', PTB_Utils::enque_min($plugin_dir . 'themify-icons/themify-icons.css'), array(), $this->version, 'all');
                }
