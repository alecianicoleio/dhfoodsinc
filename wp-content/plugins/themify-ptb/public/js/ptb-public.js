...
(function ($) {
    ...
    PTB = {
        ...
        LoadAsync: function (src, callback, version, test) {
            ...
            s.id = id;
            s.src = !version && 'undefined' !== typeof ptb ? src + '?ver=' + ptb.ver : src;
            s.async = true;
        ...
        LoadCss: function (href, version, before, media,callback) {
            var id = this.hash(href),
                ...
                existElemens =exist || document.getElementById(id),
                fullHref =!version && 'undefined' !== typeof ptb ? href + '?ver=' + ptb.ver : href; 
            if(!exist){
        ...
        is_mobile:function(){
            if(this.is_mobile===null){
                this.is_mobile = /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) ||
